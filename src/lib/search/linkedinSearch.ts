/**
 * linkedinSearch.ts — LinkedIn source adapter (best-effort).
 * Port of search/linkedin_search.py
 */
...
export async function search(
  ...
  try {
    // LinkedIn blocks direct scraping; use Bing index for LinkedIn company pages
    const query = `site:linkedin.com/company "${keyword}" import OR wholesale OR buyer`;
